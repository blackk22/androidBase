...
import com.tyl.framework.db.annotation.Column;
import com.tyl.framework.db.annotation.PrimaryKey;
import com.tyl.framework.db.annotation.TableName;
import com.tyl.framework.db.annotation.Transient;
...
public class DBUtils {
	 ...
	 */
	public static FTHashMap<String> getRowData(Cursor cursor) {
		if (cursor != null && cursor.getColumnCount() > 0) {
			FTHashMap<String> hashMap = new FTHashMap<String>();
	...
	public static Field getPrimaryKeyField(Class<?> clazz) {
		...
		if (fields != null) {
			...
			if (primaryKeyField == null) { // 没有ID注解
				...
				if (primaryKeyField == null) { // 如果没有_id的字段，有没有id的字段
					for (Field field : fields) {
	...
	public static String creatTableSql(Class<?> clazz) throws DBException {
		TableInfoEntity tableInfoEntity = TableInfofactory.getInstance().getTableInfoEntity(clazz);
