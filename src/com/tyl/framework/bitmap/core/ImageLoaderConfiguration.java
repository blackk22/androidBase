...
import com.tyl.framework.bitmap.cache.disc.naming.FileNameGenerator;
import com.tyl.framework.bitmap.cache.memory.MemoryCache;
import com.tyl.framework.bitmap.cache.memory.impl.FuzzyKeyMemoryCache;
import com.tyl.framework.bitmap.core.assist.FlushedInputStream;
...
import com.tyl.framework.bitmap.core.process.BitmapProcessor;
import com.tyl.framework.bitmap.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	private static final String TAG="ImageLoaderConfiguration";
	 ...
	 * <li>diskCache = {@link com.tyl.framework.bitmap.cache.disc.impl.UnlimitedDiskCache}</li>
	 ...
	 * </ul>
	 */
	public static ImageLoaderConfiguration createDefault(Context context,DisplayImageOptions options) {
		return new Builder(context,options).build();
	}
	...
	public static class Builder {
		...
		public Builder(Context context,DisplayImageOptions options) {
			this.context = context.getApplicationContext();
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.tyl.framework.bitmap.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		...
		public Builder taskExecutor(Executor executor) {
			if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
				L.w(TAG,WARNING_OVERLAP_EXECUTOR);
			}
		 ...
		 * {@link com.tyl.framework.bitmap.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		...
		public Builder memoryCacheSize(int memoryCacheSize) {
			...
			if (memoryCache != null) {
				L.w(TAG,WARNING_OVERLAP_MEMORY_CACHE);
			}
		 ...
		 * Default value - {@link com.tyl.framework.bitmap.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.tyl.framework.bitmap.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		public Builder diskCacheSize(int maxCacheSize) {
			...
			if (diskCache != null) {
				L.w(TAG,WARNING_OVERLAP_DISK_CACHE_PARAMS);
			}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.tyl.framework.bitmap.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.tyl.framework.bitmap.core.DefaultConfigurationFactory#createFileNameGenerator()
		 * DefaultConfigurationFactory.createFileNameGenerator()}
		 */
		public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
			if (diskCache != null) {
				L.w(TAG,WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR);
			}
		...
		/** @deprecated Use {@link #diskCache(com.tyl.framework.bitmap.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.tyl.framework.bitmap.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.firste.framework.bitmap.utils.StorageUtils#CacheDirectory.getPicDir(context)
		 * CacheDirectory.getPicDir(context)}.<br />
		 * <br />
		 ...
		 * Default value -
		 * {@link com.tyl.framework.bitmap.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.tyl.framework.bitmap.core.DefaultConfigurationFactory#createImageDecoder(boolean)
	 ...
	 * using {@link com.tyl.framework.bitmap.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
