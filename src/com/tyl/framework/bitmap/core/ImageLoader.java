...
import com.tyl.framework.bitmap.core.imageaware.NonViewAware;
...
import com.tyl.framework.bitmap.core.listener.SimpleImageLoadingListener;
import com.tyl.framework.bitmap.utils.ImageSizeUtils;
...
public class ImageLoader {
	...
	public synchronized void init(ImageLoaderConfiguration configuration) {
		...
		if (this.configuration == null) {
			L.d(TAG,LOG_INIT_CONFIG);
			engine = new ImageLoaderEngine(configuration);
			this.configuration = configuration;
		} else {
			L.w(TAG,WARNING_RE_INIT_CONFIG);
		}
	}
	 ...
	 * @param imageAware {@linkplain com.tyl.framework.bitmap.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.tyl.framework.bitmap.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.tyl.framework.bitmap.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.tyl.framework.bitmap.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.tyl.framework.bitmap.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
		...
		L.i(TAG,"是否同步："+options.isSyncLoading());
		
		if (bmp != null && !bmp.isRecycled()) {
			L.d(TAG,String.format(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, memoryCacheKey));
	 ...
	 * {@link com.tyl.framework.bitmap.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.tyl.framework.bitmap.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.tyl.framework.bitmap.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.tyl.framework.bitmap.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
	 ...
	 */
	public void destroy() {
		if (configuration != null) L.d(TAG,LOG_DESTROY);
		stop();
