...
public class TTNotification {
    ...
    private static final String TAG   = TTNotification.class.getSimpleName();
    
	/**
	 * 在状态栏显示通知
	 */
	public static void showNotification(Context context, int nid,int icon,String title,String msg) {
		...
		notification.setLatestEventInfo(context, title, msg, null);
		// 把Notification传递给NotificationManager
		notificationManager.notify(nid, notification);
	}

	public static void showNotification(Context context, int nid,int icon, String title,
			String msg, PendingIntent pintent) {
		// 创建一个NotificationManager的引用
		NotificationManager notificationManager = (NotificationManager) context
