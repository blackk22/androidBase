 ...
 * 描述：表示一个带中间竖线的TAB
 */
public class TTTabItemRedPointLineView extends LinearLayout {
     ...
     */
    public TTTabItemRedPointLineView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public TTTabItemRedPointLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setOrientation(LinearLayout.HORIZONTAL);
        this.mContext = context;
        LayoutInflater layoutInflater=LayoutInflater.from(context);
        //View view=layoutInflater.inflate(R.layout.tab_item_line_layout,null);
        View view=layoutInflater.inflate(TTResource.getIdByName(context, "layout", "tab_item_line_layout"),null);
