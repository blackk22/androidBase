 ...
 * 描述：表示一个TAB
 */
public class TTTabItemView extends LinearLayout {
     ...
     */
    public TTTabItemView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public TTTabItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        mTextView.setBackgroundColor(0xff00ff00);
        ...
        this.addView(mTextView,layout_mm);
    }
