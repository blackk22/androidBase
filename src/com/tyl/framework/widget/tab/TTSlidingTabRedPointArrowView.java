 ...
 * 描述：带下拉箭头与中间竖线、滑动的tab,tab不固定超出后可滑动.
 */
public class TTSlidingTabRedPointArrowView extends LinearLayout {
	...
	/** 下拉图标颜色. */
	//private int tabXinlaImg = R.drawable.xiala_black;
	private int tabXinlaImg = TTResource.getIdByName(context, "drawable", "xiala_black");
	
	/** 下拉选中颜色. */
	//private int tabXinlaSelectImg = R.drawable.xiala_blue;
	private int tabXinlaSelectImg = TTResource.getIdByName(context, "drawable", "xiala_blue");;
	...
	/** tab的列表. */
	private ArrayList<TTTabItemRedPointArrowView> tabItemList = null;
    ...
    private OnClickListener mTabClickListener = new OnClickListener() {
        public void onClick(View view) {
        	TTTabItemRedPointArrowView tabView = (TTTabItemRedPointArrowView)view;
     ...
     */
    public TTSlidingTabRedPointArrowView(Context context) {
        this(context, null);
    }
     ...
     */
    public TTSlidingTabRedPointArrowView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        animation=AnimationUtils.loadAnimation(context, R.anim.in_from_down); 
		...
		//内容的View的适配
  	    ...
  	    //定义Tab栏
  		tabItemList = new ArrayList<TTTabItemRedPointArrowView>();
  		tabItemTextList = new ArrayList<String>();
  		tabItemDrawableList = new ArrayList<Drawable>();
  		
  	    //要求必须是FragmentActivity的实例
		if(!(this.context instanceof FragmentActivity)){
			L.e(TTSlidingTabRedPointArrowView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
    ...
    private void addTab(String text, int index,Drawable topdDrawable) {
    	...
    	TTTabItemRedPointArrowView tabView = new TTTabItemRedPointArrowView(this.context);
    ...
    public void setCurrentItem(int item) {
        ...
        for (int i = 0; i < tabCount; i++) {
            final TTTabItemRedPointArrowView child = (TTTabItemRedPointArrowView)mTabLayout.getChildAt(i);
            final boolean isSelected = (i == item);
            child.setSelected(isSelected);
            if (isSelected) {
            	child.setXialaImg(tabXinlaSelectImg);
            	child.setTabTextColor(tabSelectColor);
                animateToTab(item);
                mViewPager.setCurrentItem(item);
            }else{
            	child.setXialaImg(tabXinlaImg);
	 ...
	 * @param draw
	 */
	public void setTabXinlaImg(int tabXinlaImg) {
		this.tabXinlaImg = tabXinlaImg;
	}
	 ...
	 * @param draw
	 */
	public void setTabXinlaSelectImg(int tabXinlaSelectImg) {
		this.tabXinlaSelectImg = tabXinlaSelectImg;
	}
