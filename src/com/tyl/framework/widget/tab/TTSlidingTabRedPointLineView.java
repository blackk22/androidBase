 ...
 */
public class TTSlidingTabRedPointLineView extends LinearLayout {
	...
	/** tab的列表. */
	private ArrayList<TTTabItemRedPointLineView> tabItemList = null;
    ...
    private OnClickListener mTabClickListener = new OnClickListener() {
        public void onClick(View view) {
        	TTTabItemRedPointLineView tabView = (TTTabItemRedPointLineView)view;
     ...
     */
    public TTSlidingTabRedPointLineView(Context context) {
        this(context, null);
    }
     ...
     */
    public TTSlidingTabRedPointLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
		...
		//内容的View的适配
  	    ...
  	    //定义Tab栏
  		tabItemList = new ArrayList<TTTabItemRedPointLineView>();
  		tabItemTextList = new ArrayList<String>();
  		tabItemDrawableList = new ArrayList<Drawable>();
  		
  	    //要求必须是FragmentActivity的实例
		if(!(this.context instanceof FragmentActivity)){
			L.e(TTSlidingTabRedPointLineView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
    ...
    private void addTab(String text, int index,Drawable topdDrawable) {
    	...
    	TTTabItemRedPointLineView tabView = new TTTabItemRedPointLineView(this.context);
    ...
    public void setCurrentItem(int item) {
        ...
        for (int i = 0; i < tabCount; i++) {
            final TTTabItemRedPointLineView child = (TTTabItemRedPointLineView)mTabLayout.getChildAt(i);
