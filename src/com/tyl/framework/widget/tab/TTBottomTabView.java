...
/**
 * 名称：FTBottomTabView.java 
 * 描述：滑动的tab.
 */
public class TTBottomTabView extends LinearLayout {
	 ...
	 */
	public TTBottomTabView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		mFragmentPagerAdapter = new TTFragmentPagerAdapter(
