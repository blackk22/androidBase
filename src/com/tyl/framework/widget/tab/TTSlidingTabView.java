 ...
 */
public class TTSlidingTabView extends LinearLayout {
     ...
     */
    public TTSlidingTabView(Context context) {
        this(context, null);
    }
     ...
     */
    public TTSlidingTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
		...
		if(!(this.context instanceof FragmentActivity)){
			L.e(TTSlidingTabView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
