 ...
 * 描述：表示一个TAB
 */
public class TTTabItemRedPointView extends LinearLayout {
     ...
     */
    public TTTabItemRedPointView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public TTTabItemRedPointView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setOrientation(LinearLayout.HORIZONTAL);
        this.mContext = context;
        LayoutInflater layoutInflater=LayoutInflater.from(context);
        //View view=layoutInflater.inflate(R.layout.tab_item_layout,null);
        View view=layoutInflater.inflate(TTResource.getIdByName(context, "layout", "tab_item_layout"),null);
