 ...
 * 描述：下拉刷新和加载更多的View.
 */
public class TTSlowPullToRefreshView extends LinearLayout {
	 ...
	 */
	public TTSlowPullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 * @param context the context
	 */
	public TTSlowPullToRefreshView(Context context) {
		super(context);
		init(context);
	}
	...
	public interface OnFooterLoadListener {
		 ...
		 * @param view the view
		 */
		public void onFooterLoad(TTSlowPullToRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		 ...
		 * @param view the view
		 */
		public void onHeaderRefresh(TTSlowPullToRefreshView view);
	}
