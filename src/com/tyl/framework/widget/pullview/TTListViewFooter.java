...
public class TTListViewFooter extends LinearLayout {
	 ...
	 */
	public TTListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(TTViewUtil.scale(mContext,100));
		footerTextView = new TextView(context);  
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		TTViewUtil.setTextSize(footerTextView,30);
		
		TTViewUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.rightMargin = TTViewUtil.scale(mContext, 10);
