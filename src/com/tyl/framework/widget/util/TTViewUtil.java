...
import com.tyl.framework.util.device.DeviceUitls;
...
public class TTViewUtil {
    ...
    public static float dip2px(Context context, float dipValue) {
        DisplayMetrics mDisplayMetrics = DeviceUitls.getDisplayMetrics(context);
    ...
    public static void scaleContentView(ViewGroup contentView){
        TTViewUtil.scaleView(contentView);
