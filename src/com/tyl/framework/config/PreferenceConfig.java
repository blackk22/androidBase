package com.tyl.framework.config;

import java.lang.reflect.Field;

import com.tyl.framework.log.L;
import com.tyl.framework.util.reflect.ReflectUtils;
 ...
 * @Package com.firstte.util.config
 * @Description PreferenceConfig是Preference类型配置文件操作类
 * @version V1.0
 */
public class PreferenceConfig implements IConfig {
	private final static String TAG = "PreferenceConfig";
